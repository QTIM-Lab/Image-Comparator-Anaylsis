...
abbr_time_Lazcano = time_Lazcano[['user', 'winner', 'image0', 'image1', 'image_name_0', 'image_name_1', 'date', 'time_diff']]
abbr_time_Alryalat = time_Alryalat[['user', 'winner', 'image0', 'image1', 'image_name_0', 'image_name_1', 'date', 'time_diff']]
abbr_time_Seibold = time_Seibold[['user', 'winner', 'image0', 'image1', 'image_name_0', 'image_name_1', 'date', 'time_diff']]
abbr_time_Malik = time_Malik[['user', 'winner', 'image0', 'image1', 'image_name_0', 'image_name_1', 'date', 'time_diff']]
abbr_time_Ittoop = time_Ittoop[['user', 'winner', 'image0', 'image1', 'image_name_0', 'image_name_1', 'date', 'time_diff']]

abbr_time_Lazcano.to_csv(os.path.join(DATA_OUT, 'time_Lazcano.csv'), index=None)
abbr_time_Alryalat.to_csv(os.path.join(DATA_OUT, 'time_Alryalat.csv'), index=None)
abbr_time_Seibold.to_csv(os.path.join(DATA_OUT, 'time_Seibold.csv'), index=None)
abbr_time_Malik.to_csv(os.path.join(DATA_OUT, 'time_Malik.csv'), index=None)
abbr_time_Ittoop.to_csv(os.path.join(DATA_OUT, 'time_Ittoop.csv'), index=None)